...
export default function AdminPage() {
  ...
  if (!isInternal) {
    return <div className="text-center py-16 text-muted-foreground">Access denied. Screem staff only.</div>;
  }
    ...
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">System administration — Screem internal only</p>
        </div>
      </div>
