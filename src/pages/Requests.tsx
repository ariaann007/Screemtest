  ...
  if (submitted) {
    return (
      <div className="max-w-md mx-auto text-center py-16 animate-fade-in">
        ...
        <p className="text-muted-foreground text-sm mb-6">Your request has been submitted. A Screem caseworker will respond shortly.</p>
    ...
    return (
      <div className="max-w-lg space-y-5 animate-fade-in">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Submit a support ticket to Screem</p>
        </div>
